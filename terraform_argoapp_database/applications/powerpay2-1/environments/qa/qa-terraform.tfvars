...
public_subnet_additionaltags = {
  ...
  "kubernetes.io/cluster/commonservicesv1-0-qa-eks" = "shared",
  "kubernetes.io/cluster/stohrmv2-0-qa-eks" = "shared",
  "kubernetes.io/cluster/powerpayv2-1-qa-eks" = "shared"
}
...
eks_cluster_name = "commonservicesv1-0-qa-eks"
eks_cluster_version = "1.29"
vpcconfig_endpoint_privateaccess = "true"
vpcconfig_endpoint_publicaccess = "false"

#eks-iam
eks_cluster_rolename = "commonservicesv1-0-qa-eksclusterrole"
eks_node_rolename = "commonservicesv1-0-qa-eksnoderole"
...
#eks-launch template
eks_node_launchtemplate_name = "commonservicesv1-0-qa-launchtemplate"

#eks-nodegroup
default_node_group_name          = "commonservicesv1-0-qa-defaultnodegroup"
...
custom_node_group_name = ["commonservicesv1-0-qa-customnodegroups"]
...
#ECR
repository_names=["commonservicesv1_0_qa_iam_service"]