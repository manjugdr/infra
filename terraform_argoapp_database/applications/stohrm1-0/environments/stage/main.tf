...
module "remoteprovisioner" {
  ...
  argocd_application_helmpath = var.argocd_application_helmpath
...
data "terraform_remote_state" "vpc" {
  ...
  config = {
    ...
    key    = "commonservices/stage/vpc/terraform.tfstate"
    region = "ap-south-1"
  }
}
...
data "terraform_remote_state" "ec2" {
  ...
  config = {
    bucket = "ascent-terraform-statefiles"
    key    = "commonservices/stage/ec2/terraform.tfstate"
    region = "ap-south-1"
  }
}
...
data "terraform_remote_state" "eks" {
  ...
  config = {
    bucket = "ascent-terraform-statefiles"
    key    = "commonservices/stage/eks/terraform.tfstate"
    region = "ap-south-1"
  }
}