...
push_nginxlogs_timezone() {
    ...
    "value": [
      {
        ...
        "persistentVolumeClaim": {
          "claimName": "stohrmv1-0nginxlog-stohrmnginxingresslogschart-logs-pvc"
        }
      }
    ]
  },
  {
    ...
    --set controller.service.annotations."service\.beta\.kubernetes\.io/aws-load-balancer-name"="storhmappv1-0-prod-nlb" \
