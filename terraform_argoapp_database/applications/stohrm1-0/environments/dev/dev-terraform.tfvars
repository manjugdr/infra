...
argocd_application_helmservicename-with-path = ["secrets:helm-deployment/stohrmchart","app:helm-deployment/stohrmchart"] #test
...
eks_cluster_name = "stohrmv2-0-dev-eks"
eks_cluster_version = "1.29"
vpcconfig_endpoint_privateaccess = "true"
vpcconfig_endpoint_publicaccess = "false"

#eks-iam
eks_cluster_rolename = "stohrmv2-0-dev-eksclusterrole"
eks_node_rolename = "stohrmv2-0-dev-eksnoderole"
...
eksclustersg_ingress_rules = {
  ...
  db_access = { from = 3306, to = 3306, proto = "tcp", cidr = "10.30.0.0/16", desc = "Allow within VPC" }
}
#eks-launch template
eks_node_launchtemplate_name = "storhmv2-0-dev-launchtemplate"
#eks-nodegroup
default_node_group_name          = "storhmv2-0-dev-defaultnodegroup"
default_node_group_instance_type = ["t3a.xlarge"]
...
custom_node_group_name = ["storhmv2-0-dev-customnodegroups"]
custom_node_group_instance_type = ["t3a.xlarge"]
custom_node_disk_size = [40]
eks_desired_size_custom_node = [1]
eks_min_size_custom_node = [1]
eks_max_size_custom_node = [10]
...
################RDS#####################################
rds_subnetgroup_name = "storhmv2-0-dev-rdsdbsubnetgroup"
rds_db_count = 1
rdssg_ingress_rules = {
...
rds_db_identifier = ["storhmv2-0-dev-rds"]
...
repository_names=["stohrmv2-0_dev_app"]
