...
module "elasticcache" {
  ...
  project_name = var.project_name  
  vpc_id = data.terraform_remote_state.vpc.outputs.vpc_id 
  subnet_ids_for_elasticcache = data.terraform_remote_state.vpc.outputs.private_subnet_ids[*]
  replication_group_id = var.replication_group_id
  replication_group_description = var.replication_group_description
  replication_group_engine                        = var.replication_group_engine
  replication_group_engine_version                = var.replication_group_engine_version
  replication_group_node_type                     = var.replication_group_node_type
  replication_group_num_cache_clusters            = var.replication_group_num_cache_clusters
  replication_group_multi_az_enabled              = var.replication_group_multi_az_enabled
  replication_group_automatic_failover_enabled    = var.replication_group_automatic_failover_enabled
  replication_group_port                          = var.replication_group_port
  replication_group_snapshot_retention_limit      = var.replication_group_snapshot_retention_limit
  replication_group_snapshot_window               = var.replication_group_snapshot_window
  replication_group_at_rest_encryption_enabled    = var.replication_group_at_rest_encryption_enabled
  replication_group_transit_encryption_enabled    = var.replication_group_transit_encryption_enabled
  replication_group_apply_immediately = var.replication_group_apply_immediately
  replication_group_maintenance_window = var.replication_group_maintenance_window
  replication_group_log_type_engine_log = var.replication_group_log_type_engine_log
  replication_group_log_type_slow_log = var.replication_group_log_type_slow_log
  replication_group_log_destination_type = var.replication_group_log_destination_type
  replication_group_log_format = var.replication_group_log_format

  elasticcache_subnet_group_name = var.elasticcache_subnet_group_name
  elasticcache_subnet_group_description = var.elasticcache_subnet_group_description

  elasticcache_param_group_name = var.elasticcache_param_group_name
  elasticcache_param_group_family      = var.elasticcache_param_group_family
  elasticcache_param_group_description = var.elasticcache_param_group_description

  elasticcache_cwlog_group_name = var.elasticcache_cwlog_group_name
  elasticcache_cwlog_group_retentiondays = var.elasticcache_cwlog_group_retentiondays

  elasticcache_sg_ingress_rules = var.elasticcache_sg_ingress_rules
