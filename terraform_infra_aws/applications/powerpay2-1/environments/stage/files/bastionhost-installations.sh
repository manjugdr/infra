...
install_nginx_ingress() {
    ...
    --set controller.service.annotations."service\.beta\.kubernetes\.io/aws-load-balancer-name"="powerpayservicesv2-1-stage-nlb" \
...
create_install_argo_app() {
    ...
    # Add powerpay cluster to argocd
