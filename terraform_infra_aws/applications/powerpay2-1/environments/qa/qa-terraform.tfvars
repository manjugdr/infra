...
eks_cluster_name = "powerpayv2-1-qa-eks"
eks_cluster_version = "1.29"
vpcconfig_endpoint_privateaccess = "true"
vpcconfig_endpoint_publicaccess = "false"

#eks-iam
eks_cluster_rolename = "powerpayv2-1-qa-eksclusterrole"
eks_node_rolename = "powerpayv2-1-qa-eksnoderole"
...
#eks-launch template
eks_node_launchtemplate_name = "powerpayv2-1-qa-launchtemplate"
#eks-nodegroup
default_node_group_name          = "powerpayv2-1-qa-defaultnodegroup"
...
custom_node_group_name = ["powerpayv2-1-qa-customnodegroups"]
...
################RDS#####################################
rds_subnetgroup_name = "powerpayv2-1-qa-rdsdbsubnetgroup"
rds_db_count = 3
rdssg_ingress_rules = {
...
rds_db_identifier = ["powerpayv2-1-qa-ge-rds","powerpayv2-1-qa-reports-rds","powerpayv2-1-qa-pe-rds"]
...
repository_names=["ppv2_1_qa_config_manager",
"ppv2_1_qa_24qprocessing_service",
"ppv2_1_qa_generalization_service",
"ppv2_1_qa_iam_service",
"ppv2_1_qa_organization_service",
"ppv2_1_qa_payroll_engine",
"ppv2_1_qa_powerpayui",
"ppv2_1_qa_reportgeneration_service",
"ppv2_1_qa_reportprocessing_service"
]
