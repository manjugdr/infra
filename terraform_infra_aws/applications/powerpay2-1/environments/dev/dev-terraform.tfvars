...
eks_cluster_name = "powerpayv2-1-dev-eks"
eks_cluster_version = "1.29"
vpcconfig_endpoint_privateaccess = "true"
vpcconfig_endpoint_publicaccess = "false"

#eks-iam
eks_cluster_rolename = "powerpayv2-1-dev-eksclusterrole"
eks_node_rolename = "powerpayv2-1-dev-eksnoderole"
...
#eks-launch template
eks_node_launchtemplate_name = "powerpayv2-1-dev-launchtemplate"
#eks-nodegroup
default_node_group_name          = "powerpayv2-1-dev-defaultnodegroup"
...
custom_node_group_name = ["powerpayv2-1-dev-customnodegroups"]
...
################RDS#####################################
rds_subnetgroup_name = "powerpayv2-1-dev-rdsdbsubnetgroup"
rds_db_count = 3
rdssg_ingress_rules = {
...
rds_db_identifier = ["powerpayv2-1-dev-ge-rds","powerpayv2-1-dev-reports-rds","powerpayv2-1-dev-pe-rds"]
...
repository_names=["ppv2_1_dev_config_manager",
"ppv2_1_dev_24qprocessing_service",
"ppv2_1_dev_generalization_service",
"ppv2_1_dev_iam_service",
"ppv2_1_dev_organization_service",
"ppv2_1_dev_payroll_engine",
"ppv2_1_dev_powerpayui",
"ppv2_1_dev_reportgeneration_service",
"ppv2_1_dev_reportprocessing_service"
]
