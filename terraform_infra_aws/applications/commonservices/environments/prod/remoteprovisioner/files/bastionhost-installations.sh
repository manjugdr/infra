...
install_externalsecretoperator() {
  ...
  helm repo update
  helm upgrade external-secrets external-secrets/external-secrets --namespace $EKS_CLUSTER_NAMESPACE
}
...
install_argo_cd() {
    ...
    kubectl apply -f files/commonservicesv1-0-tls.yaml -n "$ARGOCD_NAMESPACE"
