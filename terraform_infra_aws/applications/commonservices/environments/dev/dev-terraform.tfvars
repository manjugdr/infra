...
public_subnet_additionaltags = {
  ...
  "kubernetes.io/cluster/commonservicesv1-0-dev-eks" = "shared",
  "kubernetes.io/cluster/stohrmv2-0-dev-eks" = "shared",
  "kubernetes.io/cluster/powerpayv2-1-dev-eks" = "shared"
}
...
#eks-iam
eks_cluster_rolename = "commonservicesv1-0-dev-eksclusterrole"
eks_node_rolename = "commonservicesv1-0-dev-eksnoderole"
...
#eks-launch template
eks_node_launchtemplate_name = "commonservicesv1-0-dev-launchtemplate"

#eks-nodegroup
default_node_group_name          = "commonservicesv1-0-dev-defaultnodegroup"
...
custom_node_group_name = ["commonservicesv1-0-dev-customnodegroups"]
...
#ECR
repository_names=["commonservicesv1_0_dev_iam_service"]
